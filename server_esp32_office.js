...
<head>
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', function() { document.getElementById('temp-value').style.color = tempColor; document.getElementById('hum-value').style.color = humColor; });
...
<body>
  <div class="container">
    ...
    <div class="status-bar">
      <span class="${age < 30 ? 'status-online' : 'status-offline'}">${age < 30 ? '● 在线' : '● 离线'}</span>
